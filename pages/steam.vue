  ...
  script: [
    {
      ...
      innerHTML: JSON.stringify({
        ...
        '@type': 'ItemList',
        name: 'Steam 免费游戏',
        itemListElement: safeSteam.map((g, i) => ({
          '@type': 'ListItem',
          position: i + 1,
          item: {
            '@type': 'VideoGame',
...
<template>
  <main class="max-w-6xl mx-auto px-4 py-8">
    <section class="mb-10">
      ...
      <div v-if="safeSteam && safeSteam.length" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
